...
let firebaseConfig = {
    apiKey: "#AIzaSyAbzFsJfCqMmpIhaY1Okva4rPE6Q5nbTMk",
    authDomain: "lab4-a820c.firebaseapp.com",
    projectId: "lab4-a820c",
};
// Initialize Firebase
...
$('#save').click(()=> {
    ...
    if(!(Fname.match('^[a-zA-Z]{1,16}$')) || first == "") {
        console.log('F');
        e = true;
    ...
    if(!(Lname.match('^[a-zA-Z]{1,16}$')) || last == "") {
        console.log('L');
        e = true;
